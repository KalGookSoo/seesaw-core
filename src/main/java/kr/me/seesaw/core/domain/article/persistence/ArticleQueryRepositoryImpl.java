...
public class ArticleQueryRepositoryImpl implements ArticleQueryRepository {
    ...
    private List<Predicate> getPredicates(CriteriaBuilder cb, Root<Article> article, String categoryId, String keyField, String keyWord) {
        ...
        if (StringUtils.hasText(keyWord)) {
            ...
            switch (keyField) {
                case "title" -> predicates.add(cb.like(article.get("title"), pattern));
                case "content" -> predicates.add(cb.like(article.get("content"), pattern));
                case "createdBy" -> predicates.add(cb.like(article.get("createdBy"), pattern));
            }
        }
