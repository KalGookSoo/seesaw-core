...
public final class TimePeriod {
    ...
    private TimePeriod(LocalDateTime start, LocalDateTime end, Duration duration) {
    ...
    public static TimePeriod ofStartEnd(LocalDateTime start, LocalDateTime end) {
        return new TimePeriod(start, end, Duration.between(start, end));
    }

    public static TimePeriod ofStartDuration(LocalDateTime start, Duration duration) {
        return new TimePeriod(start, start.plus(duration), duration);
    }
